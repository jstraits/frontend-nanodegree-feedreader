...
$(function() {
    ...
    */
	...
	describe('The menu', function() {
		...
		describe ('hides the menu', function() {
		...
		describe ('menu should change on click', function(){
			it('has clicked', function() {
	...
	describe('New Feed Selection', function() {
		...
		beforeEach(function(done){
			...
			loadFeed(0, function() {
				headerOriginal = $('.feed').find("h2").text();
			});

			loadFeed(1, function() {
				headerUpdate = $('.feed').find("h2").text();
            done();
			});
		});
